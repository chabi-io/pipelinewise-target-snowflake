...
def get_db_config():
    ...
    config['private_key_file'] = os.environ.get('TARGET_SNOWFLAKE_PRIVATE_KEY_FILE')
    config['private_key_file_pwd'] = os.environ.get('TARGET_SNOWFLAKE_PRIVATE_KEY_FILE_PWD')
